...
- models.py       : OpenRouter free-model roster + live-catalogue resolution
...
from .models import (
    CHECKER, EXECUTOR, OPENROUTER_BASE_URL, PLANNER, ROSTER, SUMMARIZER,
    CatalogFetch, Model, Roster, resolve_roster,
)
...
__all__ = [
    ...
    "OPENROUTER_BASE_URL",
    "Roster", "resolve_roster", "CatalogFetch",
